...
/**
 * Sqlite-based {@link Ddth_Dao_SqlStatementFactory}.
 *
 ...
 * Sqlite-based {@link Ddth_Dao_SqlStatementFactory}.
 *
 * This factory create {@link Ddth_Dao_Sqlite_SqliteSqlStatement} if no
 * statement
 * class is specified.
 *
 * @package Dao
 ...
 */
class Ddth_Dao_Sqlite_SqliteSqlStatementFactory extends Ddth_Dao_SqlStatementFactory {
    /**
     * Constructs a new Ddth_Dao_Sqlite_SqliteSqlStatementFactory object.
     *
    ...
    protected function setStatementClass($stmClass = NULL) {
        if ($stmClass === NULL) {
            $stmClass = 'Ddth_Dao_Sqlite_SqliteSqlStatement';
        }
