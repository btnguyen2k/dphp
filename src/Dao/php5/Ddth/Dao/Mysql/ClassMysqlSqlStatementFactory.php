...
/**
 * MySQL-based {@link Ddth_Dao_SqlStatementFactory}.
 *
 ...
 * MySQL-based {@link Ddth_Dao_SqlStatementFactory}.
 *
 * This factory create {@link Ddth_Dao_Mysql_MysqlSqlStatement} if no statement
 * class is specified.
 *
 * @package Dao
 * @subpackage Mysql
 ...
 */
class Ddth_Dao_Mysql_MysqlSqlStatementFactory extends Ddth_Dao_SqlStatementFactory {
    /**
     * Constructs a new Ddth_Dao_Mysql_MysqlSqlStatementFactory object.
     *
    ...
    protected function setStatementClass($stmClass = NULL) {
        if ($stmClass === NULL) {
            $stmClass = 'Ddth_Dao_Mysql_MysqlSqlStatement';
        }
